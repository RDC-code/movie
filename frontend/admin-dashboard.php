  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-3 sidebar">
      <div class="list-group">
        ...
        <a href="#" class="list-group-item list-group-item-action" id="userLink">Manage Users</a>
    ...
    <div class="col-md-9 main-content">
      <h2>Welcome, Admin</h2>
      <p>Manage your movies, users, and reviews</p>
      ...
      <div id="userSection" class="dashboard-section" style="display: none;">
